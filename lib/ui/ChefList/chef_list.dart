...
//   final String user_id; // Thay 'chefId' bằng 'user_id'

//   Chef({required this.name, required this.imageUrl, required this.user_id});
// }
...
//               user_id: doc.id, // Thêm user_id vào mỗi user từ doc.id
//             );
//           }).toList();
...
//                   user_id: chef.user_id, // Truyền user_id vào ChefProfileScreen
//                 ),
//           ),
//         );
//       },
